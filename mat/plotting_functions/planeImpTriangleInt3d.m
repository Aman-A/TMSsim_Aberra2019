function [ num_int, pi ] = planeImpTriangleInt3d ( a, b, c, d, t )

%*****************************************************************************80
%
%% planeImpTriangleInt3d: intersection ( implicit plane, triangle ) in 3D.
%
%  Discussion:
%
...
%
  if ( num_int == 1 )
    ...
    if ( dist1 == 0.0 )
      ...
      [ num_int, pi ] = planeImpTriangleIntAdd3d ( t(1:dim_num,2), t(1:dim_num,3), ...
        dist2, dist3, num_int, pi );

    elseif ( dist2 == 0.0 )

      [ num_int, pi ] = planeImpTriangleIntAdd3d ( t(1:dim_num,1), t(1:dim_num,3), ...
        dist1, dist3, num_int, pi );

    elseif ( dist3 == 0.0 )

      [ num_int, pi ] = planeImpTriangleIntAdd3d ( t(1:dim_num,1), t(1:dim_num,2), ...
...
%
  ...
  elseif ( dist2 * dist1 < 0.0 & dist2 * dist3 < 0.0 )
    ...
    [ num_int, pi ] = planeImpTriangleIntAdd3d ( t(1:dim_num,2), t(1:dim_num,1), ...
  ...
  elseif ( dist3 * dist1 < 0.0 & dist3 * dist2 < 0.0 )
    ...
    [ num_int, pi ] = planeImpTriangleIntAdd3d ( t(1:dim_num,3), t(1:dim_num,1), ...
      dist3, dist1, num_int, pi );

    [ num_int, pi ] = planeImpTriangleIntAdd3d ( t(1:dim_num,3), t(1:dim_num,2), ...
